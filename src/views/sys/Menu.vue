        ...
        methods: {
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        this.$axios.post('/boot/sys/sysMenu' + (this.editForm.id ? 'update' : 'save'), this.editForm)
                            .then(res => {
                                this.$message({
                                    showClose: true,
                                    message: '恭喜你，操作成功',
            ...
            editHandle(id) {
                this.$axios.get('/boot/sys/sysMenu/info/' + id).then(res => {
            ...
            delHandle(id) {
                this.$axios.post('/boot/sys/sysMenu/delete/' + id).then(res => {
                    this.$message({
                        showClose: true,
                        message: '恭喜你，操作成功',
                        type: 'success',
